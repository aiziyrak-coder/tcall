...
Bu loyiha endi **Capacitor / WebView emas**. `android/app` — to‘liq **Kotlin + Jetpack Compose** native ilova.
...
- [ ] Chat (Compose + REST + Socket.IO)
- [ ] Qo‘ng‘iroq (WebRTC native)
